...
namespace FacilityMonitoring.Infrastructure.Migrations
{
    ...
    [Migration("20220209144343_AddDataConfigIteration")]
    partial class AddDataConfigIteration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.Alert", b =>
                {
                    ...
                    b.HasIndex("InputChannelId")
                        .IsUnique()
                        .HasFilter("[InputChannelId] IS NOT NULL");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.AlertLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.ModbusActionMap", b =>
                {
                    ...
                    b.Property<int>("MonitoringBoxId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.AnalogLevel", b =>
                {
                    b.HasBaseType("FacilityMonitoring.Infrastructure.Data.Model.AlertLevel");

                    b.Property<int?>("AnalogAlertId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.DiscreteLevel", b =>
                {
                    b.HasBaseType("FacilityMonitoring.Infrastructure.Data.Model.AlertLevel");

                    b.Property<int?>("DiscrteAlertId")
                        .HasColumnType("int");

                    b.Property<int>("TriggerOn")
                        .HasColumnType("int");

                    b.HasIndex("DiscrteAlertId")
                        .IsUnique()
                        .HasFilter("[DiscrteAlertId] IS NOT NULL");

                    b.HasDiscriminator().HasValue("DiscreteLevel");
                });

            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.InputChannel", b =>
                {
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.OutputChannel", b =>
                {
                    b.HasBaseType("FacilityMonitoring.Infrastructure.Data.Model.Channel");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.AnalogInput", b =>
                {
                    b.HasBaseType("FacilityMonitoring.Infrastructure.Data.Model.InputChannel");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.DiscreteOutput", b =>
                {
                    b.HasBaseType("FacilityMonitoring.Infrastructure.Data.Model.OutputChannel");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.MonitoringBox", b =>
                {
                    ...
                    b.Property<int>("DataConfigIteration")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.Alert", b =>
                {
                    b.HasOne("FacilityMonitoring.Infrastructure.Data.Model.InputChannel", "InputChannel")
                        .WithOne("Alert")
                        .HasForeignKey("FacilityMonitoring.Infrastructure.Data.Model.Alert", "InputChannelId");
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.ModbusActionMap", b =>
                {
                    ...
                    b.OwnsOne("FacilityMonitoring.Infrastructure.Data.Model.ModbusAddress", "ModbusAddress", b1 =>
                        {
                            b1.Property<int>("ModbusActionMapId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("ModbusActionMapId");

                            b1.ToTable("ModbusActionMap");

                            b1.WithOwner()
                                .HasForeignKey("ModbusActionMapId");
                        });
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.AnalogLevel", b =>
                {
                    b.HasOne("FacilityMonitoring.Infrastructure.Data.Model.AnalogAlert", "AnalogAlert")
                        .WithMany("AlertLevels")
            ...
            modelBuilder.Entity("FacilityMonitoring.Infrastructure.Data.Model.DiscreteLevel", b =>
                {
                    b.HasOne("FacilityMonitoring.Infrastructure.Data.Model.DiscreteAlert", "DiscreteAlert")
                        .WithOne("AlertLevel")
                        .HasForeignKey("FacilityMonitoring.Infrastructure.Data.Model.DiscreteLevel", "DiscrteAlertId");
                            ...
                            b1.OwnsOne("FacilityMonitoring.Infrastructure.Data.Model.ModbusConfig", "ModbusConfig", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("FacilityMonitoring.Infrastructure.Data.Model.ChannelRegisterMapping", "ChannelMapping", b3 =>
                                        {
                                            b3.Property<int>("ModbusConfigNetworkConfigurationModbusDeviceId")
                                                .HasColumnType("int");

                                            b3.Property<int>("ActionRegisterType")
                                                .HasColumnType("int");

                                            b3.Property<int>("ActionStart")
                                                .HasColumnType("int");

                                            b3.Property<int>("ActionStop")
                                                .HasColumnType("int");

                                            b3.Property<int>("AlertRegisterType")
                                                .HasColumnType("int");

                                            b3.Property<int>("AlertStart")
                                                .HasColumnType("int");

                                            b3.Property<int>("AlertStop")
                                                .HasColumnType("int");

                                            b3.Property<int>("AnalogRegisterType")
                                                .HasColumnType("int");

                                            b3.Property<int>("AnalogStart")
                                                .HasColumnType("int");

                                            b3.Property<int>("AnalogStop")
                                                .HasColumnType("int");

                                            b3.Property<int>("DeviceRegisterType")
                                                .HasColumnType("int");

                                            b3.Property<int>("DeviceStart")
                                                .HasColumnType("int");

                                            b3.Property<int>("DeviceStop")
                                                .HasColumnType("int");

                                            b3.Property<int>("DiscreteRegisterType")
                                                .HasColumnType("int");

                                            b3.Property<int>("DiscreteStart")
                                                .HasColumnType("int");

                                            b3.Property<int>("DiscreteStop")
                                                .HasColumnType("int");

                                            b3.Property<int>("OutputRegisterType")
                                                .HasColumnType("int");

                                            b3.Property<int>("OutputStart")
                                                .HasColumnType("int");

                                            b3.Property<int>("OutputStop")
                                                .HasColumnType("int");

                                            b3.Property<int>("VirtualRegisterType")
                                                .HasColumnType("int");

                                            b3.Property<int>("VirtualStart")
                                                .HasColumnType("int");

                                            b3.Property<int>("VirtualStop")
                                                .HasColumnType("int");

                                            b3.HasKey("ModbusConfigNetworkConfigurationModbusDeviceId");

                                            b3.ToTable("Devices");

                                            b3.WithOwner()
                                                .HasForeignKey("ModbusConfigNetworkConfigurationModbusDeviceId");
                                        });

                                    b2.OwnsOne("FacilityMonitoring.Infrastructure.Data.Model.ModbusAddress", "ModbusAddress", b3 =>
                                        {
                                            b3.Property<int>("ModbusConfigNetworkConfigurationModbusDeviceId")
                                                .HasColumnType("int");

                                            b3.Property<int>("Address")
                                                .HasColumnType("int");

                                            b3.Property<int>("RegisterLength")
                                                .HasColumnType("int");

                                            b3.Property<int>("RegisterType")
                                                .HasColumnType("int");
                                    ...
                                    b2.Navigation("ChannelMapping");

                                    b2.Navigation("ModbusAddress");
                                });
